    ...
    <div class="table">
      <table>
        ...
        <tr v-for="(item, index) in rspData.list">
          ...
          <td>
            <input type="text" v-model="item.lmNo"/>
          </td>
          <td>
            <input type="text" v-model="item.ownerName"/>
          </td>
          <td>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      checkTime (rspData) {
        let timeLimit = config.getTimeLimit(rspData.createdDt, 'BIZ-DATA-EDIT-TIME-LIMIT-07', 15)
